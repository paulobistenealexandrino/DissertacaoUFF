...
# DEPOIS da intervenção apenas com linhas que
# cumpriram, em média, 80% ou mais do plano operacional
...
folder <- "input/data_processed/analise_impacto/depois23linhas"
...
{computation_time <- system.time(
  ttm_depois23 <- travel_time_matrix(
    conexao_r5,
...
saveRDS(ttm_depois23,"input/data_processed/analise_impacto/ttm_depois23linhas.RDS")
